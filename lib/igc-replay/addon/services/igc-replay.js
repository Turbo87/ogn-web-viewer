...
import { all, waitForProperty } from 'ember-concurrency';
...
export default class extends Service {
  ...
  @task
  replayFileTask = function*(filename, ognID) {
    ...
    let replay = new IGCFileReplay(parsed, Date.now(), fix => {
      if (this.socket) {
